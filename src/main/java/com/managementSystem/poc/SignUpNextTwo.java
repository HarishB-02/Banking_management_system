...
public class SignUpNextTwo extends JFrame implements ActionListener{
...
//        add(l14);
        ...
        try{
            if(ae.getSource()==b1){
                ...
                if(atype.equals("")){
                    ...
                    String q1 = "insert into signupnexttwo values('"+formno+"','"+atype+"','"+cardno+"','"+pin+"','"+facility+"')";
    ...
    public static void main(String[] args){
        new SignUpNextTwo("").setVisible(true);
    }
